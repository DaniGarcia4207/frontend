...
export default function CarritoContents(){
    ...
    //esta funcion da formato a los numeros o cantidades
    const formatoNumero = (number)=>{
        return new Intl.NumberFormat().format(number)
    }

    //esta linea suma los valores parciales de cada producto y arroja un total
    const precioTotalCarrito = comprasDelCarrito.reduce((a,b)=> a+b.precioCarrito,0)
